...
import {fetchUsers, messageAddMessage} from './SendMessageAction'
...
const select_types = {
    volunteers: "Alle Vrijwilligers", sectors: "Alle Sectorverantwoordelijken",
...
class SendNotificationPage extends Component<any> {
    ...
    renderListOfUser() {
        ...
        if (Auth.getAuthenticatedUser().permission_type_id === 1) {
            ...
            if (this.props.localStorage.managers.length > 0) {
                ...
                return (
                    <IonSelect interface="popover" value={manager.user_id} placeholder={manager.user_name}
                               onIonChange={e => this.handleQuickBtnChange(e.detail.value)}>
            ...
            return (
                <IonSelect interface="popover" value={this.state.selected_type} placeholder={this.state.selected_type}
                           onIonChange={e => this.handleQuickBtnChange(e.detail.value)}>
        ...
        if (this.props.localStorage !== undefined) {
            return (
                <div>
                    ...
                    <IonItem>
                        <IonInput value={title_value} placeholder="Titel..."
                                  onIonChange={e => this.handleTitleChange(e.detail.value)}/>
                    </IonItem>

                    <IonItem>
                        <IonTextarea className="textArea" value={content_value} placeholder="Bericht..."
                                     onIonChange={e => this.handleContentChange(e.detail.value)}></IonTextarea>
                    </IonItem>
                    ...
                    <IonItem>
                        <IonGrid>
                            <IonRow>
                                <IonCol size="6">
                                    <IonButton float-left onClick={() => this.showPopOverTemplate()}> Template
                                        bericht</IonButton>
                                    <>
                                        <IonPopover
...
export default connect(mapStateToProps, mapDispatchToProps)(withIonLifeCycle(SendNotificationPage));
