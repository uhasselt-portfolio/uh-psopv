...
class NotificationPage extends Component<any> {
    ...
    renderList() {
        if (this.props.localStorage !== undefined) {
            ...
            return <div> Geen internet verbinding ... </div>
        }
    }
    ...
    render() {
        if (this.props.localStorage !== undefined) {
            ...
            if (!this.props.localStorage.loaded) {
                button =
                    <IonButton className="marginBottom" onClick={() => this.loadMoreMessage()}> Meer berichten laden
                        ... </IonButton>
            } else {
                button = <div></div>;
            }
            ...
            return (
                <div>Berichten zijn aan het laden</div>
            )
        }
    }
...
export default connect(mapStateToProps, mapDispatchToProps)(withIonLifeCycle(NotificationPage));
